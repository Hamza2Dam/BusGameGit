...
public class ScrollGasoil : MonoBehaviour
{
    ...
    public float speed = 5f; // Velocitat del scroll
    ...
    void SpawnNext()
    {
        ...
        if (randomNumber == 1)  // Si el numero random == 1 spawneja l'objecte al carril1.
        {
            ...
            Object.transform.position = new Vector3(carril1.transform.position.x, 50, 0); // Igualem la posicio x del objecte amb la del carril corresponent.
        }
        else if (randomNumber == 2)
        {
            Object.transform.position = new Vector3(carril2.transform.position.x, 50, 0);

        }

        else if (randomNumber == 3)
        {
            Object.transform.position = new Vector3(carril3.transform.position.x, 50, 0);
